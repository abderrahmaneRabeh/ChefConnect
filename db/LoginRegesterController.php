...
function Check_Exist_User($conx, $email)
{
...
function Check_Role($conx, $email)
{
    $sql = "SELECT roles.type_role, utilisateurs.id_utilisateur FROM utilisateurs JOIN roles ON utilisateurs.role_id = roles.id_role WHERE email = '$email'";
